...
#from models.CLR_Modelv2 import ContrastiveLearningModel
...
def parse_args():
    ...
    parser.add_argument('--data-path', default='/home/pod/msr_action', type=str, help='dataset')
    ...
    parser.add_argument('--finetune', default='/home/pod/shared-nvme/Pretrainckpt/9303/pretrain/checkpoint_149.pth', help='finetune from checkpoint')
    parser.add_argument('--output-dir', default='/home/pod/shared-nvme/FineTune_4loss_msr_wmoco/179', type=str, help='path where to save')
    parser.add_argument('--log-dir', default='/home/pod/shared-nvme/FineTune_4loss_msr_wmoco/179', type=str, help='path where to save')
