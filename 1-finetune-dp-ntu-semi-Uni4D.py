...
def parse_args():
    ...
    parser.add_argument('--data-meta', default='/home/pod/shared-nvme/ReSD/datasets/ntu60_train_30_eval_30.list', help='dataset')
    ...
    parser.add_argument('--eval-print-freq', default=500, type=int, help='print frequency')
    parser.add_argument('--start-epoch', default=0, type=int, metavar='N', help='start epoch')

    parser.add_argument('--finetune', default='/home/pod/shared-nvme/Log_4loss_ntu/NTU60/checkpoint_59.pth', help='finetune from checkpoint')
    #parser.add_argument('--finetune', default='', help='finetune from checkpoint')
    parser.add_argument('--output-dir', default='/home/pod/shared-nvme/FineTune_semi_ntu', type=str, help='path where to save')
    parser.add_argument('--log-dir', default='/home/pod/shared-nvme/FineTune_semi_ntu', type=str, help='path where to save')
