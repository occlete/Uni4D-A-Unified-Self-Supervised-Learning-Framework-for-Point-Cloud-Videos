...
from datasets.shrec17 import SHRECLoader
from models.ReSDP4NTU import ContrastiveMaskedAutoEncoder
...
def train(model, criterion, optimizer, lr_scheduler, data_loader, 
    ...
    for i, (clip, target) in enumerate(data_loader):
        ...
        #loss = (loss - 1.2).abs() + 1.2#prevent overfitting
...
def main(args):
    ...
    if args.finetune:
        ...
        assert log.missing_keys == ['module.cls_token_ft', 'module.cls_pos_ft',
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_loss, test_top1, test_top5 = evaluate(model, criterion, val_loader, 
                                                        device, args.eval_print_freq, logger)
        acc = max(acc, test_top1)
...
def parse_args():
    ...
    parser.add_argument('--nsamples', default=9 ,
                        
                        type=int, help='number of neighbors for the ball query')
    parser.add_argument('--spatial-stride', default=8, type=int, help='spatial subsampling rate')
    ...
    parser.add_argument('--eval-print-freq', default=10, type=int, help='print frequency')
    parser.add_argument('--start-epoch', default=0, type=int, metavar='N', help='start epoch')

    parser.add_argument('--finetune', default='/mnt/data/home/zuozhi/Log_4loss_ntu/NTU60/checkpoint_99.pth', help='finetune from checkpoint')
    #parser.add_argument('--finetune', default='', help='finetune from checkpoint')
    parser.add_argument('--output-dir', default='/mnt/ssd1/zz/CoMR/log/shrec', type=str, help='path where to save')
    parser.add_argument('--log-dir', default='/mnt/ssd1/zz/CoMR/log/shrec', type=str, help='path where to save')
