...
def parse_args():
    ...
    parser.add_argument('--eval-print-freq', default=1000, type=int, help='print frequency')
    parser.add_argument('--start-epoch', default=0, type=int, metavar='N', help='start epoch')

    parser.add_argument('--finetune', default='/home/pod/shared-nvme/Log_4loss_ntu/NTU60/checkpoint_159.pth', help='finetune from checkpoint')
    #parser.add_argument('--finetune', default='', help='finetune from checkpoint')
    parser.add_argument('--output-dir', default='/home/pod/shared-nvme/FineTune_4loss_ntulr0_0005', type=str, help='path where to save')
    parser.add_argument('--log-dir', default='/home/pod/shared-nvme/FineTune_4loss_ntulr0_0005', type=str, help='path where to save')
