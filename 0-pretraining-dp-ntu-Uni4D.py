...
from models.Uni4DNTU import ContrastiveMaskedAutoEncoder
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        tf_writer.flush()
        if epoch>0:
            if (epoch + 1) % 10 == 0:#9 19 29 39 49 59 69 79 89 99 109 119 129 139 149
                checkpoint = {
...
def parse_args():
    ...
    parser.add_argument('--data-path', default='/home/pod/shared-nvme/ntu/ntu', metavar='DIR', help='path to dataset')
    parser.add_argument('--data-meta', default='/home/pod/shared-nvme/ReSD/datasets/ntu60.list', help='dataset')
    parser.add_argument('--epochs', default=160, type=int, metavar='N', help='number of total epochs to run')
    parser.add_argument('--lr-warmup-epochs', default=10, type=int, help='number of warmup epochs')
    parser.add_argument('-b', '--batch-size', default=112, type=int, metavar='N', help='batch size')
    ...
    parser.add_argument('--queue_size', default=14336, type=float, help='Momentum parameter for the momentum encoder')
    # input
    ...
    parser.add_argument('--log-dir', default='/home/pod/shared-nvme/Log_4loss_ntu', type=str, help='path where to save')
