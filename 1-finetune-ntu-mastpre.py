...
def parse_args():
    ...
    parser.add_argument('--data-path', default='/home/pod/shared-nvme/ntu10%', metavar='DIR', help='path to dataset')
    parser.add_argument('--data-meta', default='/home/pod/shared-nvme/ReSD/datasets/ntu60_train_10_eval_10.list', help='dataset')
    ...
    parser.add_argument('--print-freq', default=700, type=int, help='print frequency')
    parser.add_argument('--eval-print-freq', default=100, type=int, help='print frequency')
    parser.add_argument('--start-epoch', default=0, type=int, metavar='N', help='start epoch')

    parser.add_argument('--finetune', default='/home/pod/shared-nvme/checkpoint_178.pth', help='finetune from checkpoint')
