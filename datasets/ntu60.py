...
if __name__ == '__main__':
    dataset = NTU60Subject(root='/home/pod/shared-nvme/ntu',
                           meta='/home/pod/shared-nvme/ReSD/datasets/ntu60.list', 
                           frames_per_clip=24,
                           step_between_clips=2, 
                           num_points=2048,
                           train=True)
    import torch
    data_loader = torch.utils.data.DataLoader(dataset, batch_size=96, shuffle=True, num_workers=32, pin_memory=True)
